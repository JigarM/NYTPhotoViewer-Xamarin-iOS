...
namespace NYTPhotoViewerWithRemoteImageSupport
{
	...
	[Protocol, Model]
	interface INYTPhotosViewControllerDataSource// : NSFastEnumeration
	{
		...
		// @required -(void)removePhotoAtIndex:(NSUInteger)photoIndex;
		[Abstract]
		[Export ("removePhotoAtIndex:")]
		void RemovePhotoAtIndex (nuint photoIndex);
	
		// @required -(void)appendPhotos:(NSArray<NYTPhoto *> *)photos;
		[Abstract]
		[Export ("appendPhotos:")]
		void AppendPhotos (NYTPhoto[] photos);
	}
	...
	interface NYTPhotosDataSource : INYTPhotosViewControllerDataSource
	{
		...
		// -(void)appendPhotos:(NSArray<NYTPhoto *> * _Nonnull)photos;
		[Export ("appendPhotos:")]
		void AppendPhotos (NYTPhoto[] photos);
	}
	...
	interface NYTPhotosViewController
	{
		...
		// -(instancetype _Nonnull)initWithPhotos:(NSArray<NYTPhoto *> * _Nonnull)photos initialPhoto:(NYTPhoto * _Nonnull)initialPhoto withMaximumZoomScale:(CGFloat)maximumZoomScale;
		[Export ("initWithPhotos:initialPhoto:withMaximumZoomScale:")]
		IntPtr Constructor (NYTPhoto[] photos, NYTPhoto initialPhoto, nfloat maximumZoomScale);
		...
		// -(void)deletePhoto:(NYTPhoto * _Nonnull)photo;
		[Export ("deletePhoto:")]
		void DeletePhoto (NYTPhoto photo);
	
		// -(void)appendImages:(NSArray<NYTPhoto *> * _Nonnull)photos;
		[Export ("appendImages:")]
		void AppendImages (NYTPhoto[] photos);
	}
	...
	interface NYTPhotosViewControllerDelegate
	{
		...
		// @optional -(void)photosViewController:(NYTPhotosViewController * _Nonnull)photosViewController handleTapForPhoto:(NYTPhoto * _Nonnull)photo withGestureRecognizer:(UITapGestureRecognizer * _Nonnull)tapGestureRecognizer;
		[Export ("photosViewController:handleTapForPhoto:withGestureRecognizer:")]
		void HandleTapForPhoto (NYTPhotosViewController photosViewController, NYTPhoto photo, UITapGestureRecognizer tapGestureRecognizer);
